...
import { parseTargetsFromOutput, groupTargets, isDebugScope, filterTargetsForScope, type BuildTargetInfo } from '../commands/runBuildCurrentSpecCommand/helpers/targetHelpers';
...
`;
  ...
  suite('filterTargetsForScope', () => {
    test('filters targets for specific scope with slash', () => {
      ...
      const filtered = filterTargetsForScope(targets, 'mariner2');
