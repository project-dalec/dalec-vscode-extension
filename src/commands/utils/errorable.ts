/**
 * Errorable type and utility functions for type-safe error handling.
 * Based on the pattern from Azure/vscode-aks-tools.
 */
...
export function failure(error: string): Failed {
